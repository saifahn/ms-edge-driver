...
var getBrowserBinaryOnLinux = function () { return __awaiter(void 0, void 0, void 0, function () {
    var path, fullVer, match, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, execAsync("which microsoft-edge")];
            case 1:
                path = (_a.sent()).stdout;
                // which includes a newline that we should get rid of
                path = path.trim();
                return [4 /*yield*/, execAsync("microsoft-edge --version")];
            case 2:
                fullVer = (_a.sent()).stdout;
                match = fullVer.toString().match(/\d{1,}.\d{1,}.\d{1,}.\d{1,}/g);
                if (match)
                    return [2 /*return*/, { path: path, version: match[0] }];
                return [3 /*break*/, 4];
            case 3:
                err_3 = _a.sent();
...
var getBrowserData = function (edgeBinaryPath) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(0, os_1.isWin)()) return [3 /*break*/, 2];
                return [4 /*yield*/, getBrowserBinaryOnWin()];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                if (!(process.platform === 'darwin')) return [3 /*break*/, 4];
                return [4 /*yield*/, getBrowserBinaryOnMac(edgeBinaryPath)];
            case 3: return [2 /*return*/, _a.sent()];
            case 4:
                if (!(process.platform === 'linux')) return [3 /*break*/, 6];
                return [4 /*yield*/, getBrowserBinaryOnLinux()];
